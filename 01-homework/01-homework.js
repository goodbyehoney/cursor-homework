...
// Цей пункт в мене просто випав. Розумію, що тут потрібно працювати с Math, але не розумію, як зробити округлення числа до 100

console.log("Тут я просто зломався і потребую підказки :)")
...
5. сума товарів округлену до сотень: 
